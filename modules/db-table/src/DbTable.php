...
namespace VendorPlugin\Modules\DbTable;
...
final class DbTable implements ModuleInterface {
	...
	public function register(): void {
		add_filter( '{{PREFIX}}_db_schema', [ $this, 'add_schema' ] );
		add_filter( '{{PREFIX}}_db_tables', [ $this, 'add_table_name' ] );
	}
	...
	public static function table_name(): string {
		...
		return $wpdb->prefix . '{{PREFIX}}_records';
	}
